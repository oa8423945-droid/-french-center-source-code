...
function renderReports(section = 'home') {
  ...
  const sectionViews = {
    ...
    employees: `<div class="reports-subpage-head"><button class="back-btn" type="button" data-report-section="home">→ رجوع للتقارير</button><div><span class="eyebrow">تقارير الموظفين</span><h2>الموظفين</h2><p>تقارير الموظفين والمرتبات والسلف.</p></div></div><div class="empty-state compact-empty reports-coming-soon"><strong>قريبًا</strong><span>سيتم إضافة تقارير الموظفين في تحديث قادم.</span></div>`,
  };
