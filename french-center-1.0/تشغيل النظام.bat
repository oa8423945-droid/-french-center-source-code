...
setlocal
cd /d "%~dp0"
if defined GARAGE_DATA_FILE goto data_ready
if exist "..\02-قاعدة-البيانات\main data 2.xlsx" set "GARAGE_DATA_FILE=%CD%\..\02-قاعدة-البيانات\main data 2.xlsx"
if not defined GARAGE_DATA_FILE if exist "data\main data 2.xlsx" set "GARAGE_DATA_FILE=%CD%\data\main data 2.xlsx"
if not defined GARAGE_DATA_FILE goto missing_data
:data_ready
